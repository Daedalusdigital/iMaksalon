...
<div class="status"><?php echo @$response;?></div>
        ...
        <div class="container">
          <nav id="menuzord-right" class="menuzord">
            ...
            <ul class="menuzord-menu">
              ...
              <li><a href="#" class="btn btn-success" onclick="document.getElementById('id01').style.display='block'">Login</a></li>
              <li style="margin-left:5px;"><a href="javascript:void(0)" class="btn btn-success" onclick="document.getElementById('id02').style.display='block'" >Sign Up</a></li>
            </ul>
          </nav>
        </div>
      </div>
  ...
  <div class="main-content">
          ...
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg10.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/slider/bg6.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
              ...
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg1.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/slider/NEW.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-default btn-lg btn-circled mr-10" href="#" onclick="document.getElementById('id02').style.display='block'">Register</a> <a class="btn btn-colored btn-lg btn-circled btn-theme-colored" href="#" onclick="document.getElementById('id01').style.display='block'">Login</a>
                </div>
              </li>
              ...
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg16.jpg" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/slider/bg16.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-black-333 text-uppercase font-playfair font-weight-600" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap; font-weight:700;">Wo<span class="text-theme-colored">men's</span>
                </div>
        ...
        <div class="section-content">
          <div class="row equal-height-inner">
            <div class="col-sm-12 col-md-6 p-0 p-xs-10 sm-height-auto mt-sm-0" data-margin-top="-200px">
              <div class="text-black sm-height-auto" data-bg-img="images/about/1.jpg">
                <div class="p-20 pl-50 pr-50">
                  <h3 class="text-white text-uppercase">How to find your local<br>Salons location.</h3>
                  <p>Something Something Something, Something Something Something. Something Something Something Something Something Something Something Something Something.</p>
                  <a href="#" class="btn btn-dark btn-md btn-flat mt-10 hvr-bounce-to-left no-border">View Map</a>
                </div>
              </div>
            </div>
            <div class="col-sm-12 col-md-6 p-0 p-xs-10 sm-height-auto mt-sm-0" data-margin-top="-200px">
              <div class="text-black mt-sm-10 sm-height-auto" data-bg-img="images/about/2.jpg">
                <div class="p-20 pl-50 pr-50">
                  <h3 class="text-white text-uppercase">Opening Hours! <br>Check Our Class Here</h3>
                  <div class="line-bottom mb-10"></div>
                  <div class="opening-hours">
                    <p><span class="text-white">Monday To Friday: 8:00 am to 8:00 pm</span> </p>
          ...
          <div class="section-title text-center" id="about">
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <h2 class="text-uppercase title" >About <span class="text-black font-weight-300"> <b>iMakapp</b></span></h2>
                  <p class="text-uppercase letter-space-4">WHY CHOOSE US?</p>
                </div>
              </div>
            </div>
        <div class="section-content">
          <div class="row">
            <div class="col-md-6 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <h5 class="letter-space-8 text-uppercase text-theme-colored"></h5>
              <p><span class="dropcap">S</span>omething Something Something, Something Something Something. Something Something Something Something Something Something Something Something SomethingSomething Something Something, Something Something Something. Something Something Something Something Something Something Something Something Something.</p>
              <a href="" class="btn btn-theme-colored btn-flat mt-10"> Read More</a>
            </div>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
            <div class="section-content text-center">
              ...
              <a href="" class="btn btn-theme-colored btn-flat mt-10 btn-xl text-uppercase"> Contact Us</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="icon-box text-center pl-0 pr-0 mb-0">
                <a href="#" class="icon bg-theme-colored icon-circled icon-border-effect effect-circle icon-xl">
            ...
            <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
              <div class="icon-box text-center pl-0 pr-0 mb-0">
                <a href="#" class="icon bg-theme-colored icon-circled icon-border-effect effect-circle icon-xl">
            ...
            <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="icon-box text-center pl-0 pr-0 mb-0">
                <a href="#" class="icon bg-theme-colored icon-circled icon-border-effect effect-circle icon-xl">
            ...
            <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.6s">
              <div class="icon-box text-center pl-0 pr-0 mb-0">
                <a href="#" class="icon bg-theme-colored icon-circled icon-border-effect effect-circle icon-xl">
                  <i class="flaticon-salon-scissors-and-comb text-white"></i>
                </a>
                <h4 class="icon-box-title mt-15 mb-10 letter-space-4 text-uppercase"><strong>Hair Cutting Style</strong></h4>
                <p>Eleifend lobortis bibendum volutpat est senectus duis convallis augue hendrerit senectus duis</p>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.7s">
              <div class="icon-box text-center pl-0 pr-0 pt-0">
                <a href="#" class="icon bg-theme-colored icon-circled icon-border-effect effect-circle icon-xl">
                  <i class="flaticon-salon-hairdresser-with-combs text-white"></i>
                </a>
                <h4 class="icon-box-title mt-15 mb-10 letter-space-4 text-uppercase"><strong>Hair Styling</strong></h4>
                <p>Eleifend lobortis bibendum volutpat est senectus duis convallis augue hendrerit senectus duis</p>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.8s">
              <div class="icon-box text-center pl-0 pr-0 pt-0">
                <a href="#" class="icon bg-theme-colored icon-circled icon-border-effect effect-circle icon-xl">
                  <i class="flaticon-salon-long-female-hair-tincture text-white"></i>
                </a>
                <h4 class="icon-box-title mt-15 mb-10 letter-space-4 text-uppercase"><strong>Hair Color</strong></h4>
                <p>Eleifend lobortis bibendum volutpat est senectus duis convallis augue hendrerit senectus duis</p>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.9s">
              <div class="icon-box text-center pl-0 pr-0 pt-0">
                <a href="#" class="icon bg-theme-colored icon-circled icon-border-effect effect-circle icon-xl">
                  <i class="flaticon-salon-hair-straightener-on-long-female-hair text-white"></i>
                </a>
                <h4 class="icon-box-title mt-15 mb-10 letter-space-4 text-uppercase"><strong>Hair Straighting</strong></h4>
                <p>Eleifend lobortis bibendum volutpat est senectus duis convallis augue hendrerit senectus duis</p>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
              <div class="icon-box text-center pl-0 pr-0 pt-0">
                <a href="#" class="icon bg-theme-colored icon-circled icon-border-effect effect-circle icon-xl">
                  <i class="flaticon-salon-hairdryer-and-comb text-white"></i>
                </a>
                <h4 class="icon-box-title mt-15 mb-10 letter-space-4 text-uppercase"><strong>Hair Dring</strong></h4>
                <p>Eleifend lobortis bibendum volutpat est senectus duis convallis augue hendrerit senectus duis</p>
              </div>
            </div>
          </div>
    ...
    <!-- Divider: Funfact -->
    <section class="divider parallax layer-overlay overlay-dark-8" data-bg-img="images/bg/bg7.jpg" data-parallax-ratio="0.7">
        ...
        <div class="row">
          <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 mb-md-50">
            <div class="funfact text-right mr-20">
              <div class="funfact-icon xs-pull-none pull-right flip mr-sm-150 mr-xs-0 mr-50 mr-md-30">
                <i data-text-color="#ccc" class="pe-7s-smile text-black-light mt-20 font-48"></i>
              </div>
              <div class="funfact-content xs-pull-none pull-left flip">
                <h2 data-animation-duration="2000" data-value="200" class="animate-number text-theme-colored font-montserrat font-48 font-weight-300 line-top-right">0</h2>
                <div class="clearfix"></div>
                <h4 class="font-raleway font-16 font-weight-500 text-white mt-5">Happy Clients
                </h4>
              </div>
            </div>
          </div>
          <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 mb-md-50">
            <div class="funfact text-right mr-20">
              <div class="funfact-icon xs-pull-none pull-right flip mr-sm-150 mr-xs-0 mr-50 mr-md-30">
                <i data-text-color="#ccc" class="pe-7s-like text-black-light mt-20 font-48"></i>
              </div>
              <div class="funfact-content xs-pull-none pull-left flip">
                ...
                <div class="clearfix"></div>
                <h4 class="font-raleway font-16 font-weight-500 text-white mt-5">Listed Sytlists
                </h4>
              </div>
            </div>
          </div>
          <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 mb-md-50">
            <div class="funfact text-right mr-20">
              <div class="funfact-icon xs-pull-none pull-right flip mr-sm-150 mr-xs-0 mr-80 mr-md-50">
                <i data-text-color="#ccc" class="pe-7s-medal text-black-light mt-20 font-48"></i>
              </div>
              <div class="funfact-content xs-pull-none pull-left flip">
                ...
                <div class="clearfix"></div>
                <h4 class="font-raleway font-16 font-weight-500 text-white mt-5">Award Won
                </h4>
              </div>
            </div>
          </div>
          <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 mb-md-50">
            <div class="funfact text-right mr-20">
              <div class="funfact-icon xs-pull-none pull-right flip mr-sm-150 mr-xs-0 mr-50 mr-md-30">
                <i data-text-color="#ccc" class="pe-7s-coffee text-black-light mt-20 font-48"></i>
              </div>
              <div class="funfact-content xs-pull-none pull-left flip">
                ...
                <div class="clearfix"></div>
                <h4 class="font-raleway font-16 font-weight-500 text-white mt-5">Cup Of Coffee
                </h4>
              </div>
            </div>
          </div>
    ...
    <!-- Section: Stylists -->
    <section class="divider bg-lighter" id="stylists">
      <div class="clients-section">
        <div class="container">
            <div class="section-title text-center">
                <div class="row">
                  <div class="col-md-8 col-md-offset-2">
                    <h2 class="text-uppercase title" >Our <span class="text-black font-weight-300"> Stylists</span></h2>
                    <p class="text-uppercase letter-space-4">Ratings.</p>
                  </div>
                </div>
              </div>
          <div class="mis-stage"> 
            ...
            <ol class="mis-slider">
              ...
              <li class="mis-slide"> <a href="#" class="mis-container">
                ...
                <figcaption>Rosy Crisp</figcaption>
                <span class="fa fa-star checked"></span>
                <span class="fa fa-star checked"></span>
                <span class="fa fa-star checked"></span>
                <span class="fa fa-star checked"></span>
  ...
  <footer id="footer" class="footer divider parallax layer-overlay overlay-dark-9" data-bg-img="images/bg/bg7.jpg" data-parallax-ratio="0.7">
    ...
    <div class="footer-bottom bg-black-333">
      <div class="container pt-20 pb-20">
        <div class="row">
          <div class="col-md-6">
            <p class="font-11 text-black-777 m-0">Copyright &copy;2017 Daedalus digital. All Rights Reserved</p>
          </div>
